---
title: "Run a Coding Agent in BoxLite"
description: "Run a coding agent on your project inside an isolated BoxLite sandbox. This tutorial uses Claude Code as the concrete example."
sidebarTitle: "Coding Agent in BoxLite"
---
