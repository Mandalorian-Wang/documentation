...
<Tabs>
  <Tab title="OpenAI">
    ```bash
    python3 -m pip install boxlite openai
    export OPENAI_API_KEY="sk-..."
    ```
  </Tab>
  <Tab title="Anthropic">
    ```bash
    python3 -m pip install boxlite anthropic
...
<Tip>
  For production deployments — concurrency models, timeout handling, security presets, and defensive execution patterns — see the [AI agent production patterns guide](/guides/ai-agent-integration).
</Tip>
