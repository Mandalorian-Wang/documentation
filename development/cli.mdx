---
title: "CLI Reference"
description: "BoxLite command-line interface reference"
---

This guide covers building, testing, and contributing to the BoxLite CLI (`boxlite`). The CLI is implemented in the `boxlite-cli` crate and follows the same [Rust Style Guide](/development/rust-style) as the rest of the project.
...
- [Rust Style Guide](/development/rust-style) — coding standards for BoxLite.
- [CONTRIBUTING.md](https://github.com/boxlite-ai/boxlite/blob/main/CONTRIBUTING.md) — general contribution workflow.
- [boxlite-cli README](https://github.com/boxlite-ai/boxlite/blob/main/boxlite-cli/README.md) — user-facing CLI documentation.
