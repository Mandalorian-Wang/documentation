...
A volume also costs less than keeping a stopped box around: a mounted volume adds nothing to a box's hourly price, while a stopped box is billed for its disk until it is deleted. See [What a box costs](/cloud/box-costs).
