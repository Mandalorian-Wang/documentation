...
description: "The four operations the volume API exposes, one script that runs all of them, and the two behaviours that catch people out: deletion is asynchronous, and size is never reported."
---

The volume API has exactly four operations. This page runs all four end to end, then covers the two behaviours that surprise people.
