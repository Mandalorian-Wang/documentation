...
description: "How a volume is addressed by name or id, the parameters and return shapes of every volume call, the mount tuple, read-only behaviour, and what differs from open source."
---
