...
<Note>
  This page covers mounting a directory from the host you are running on. On BoxLite Cloud there is no such host, and a host bind mount is ignored — you mount a managed volume by id instead. See [Persistent volumes on BoxLite Cloud](/cloud/volumes).
</Note>
