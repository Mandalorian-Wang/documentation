...
<Note>
  This page covers pointing the client at a server you run. The same client also reaches BoxLite Cloud, where the server is managed for you — see [What is BoxLite Cloud](/cloud/index) and [Run untrusted code on BoxLite Cloud](/cloud/quickstart).
</Note>
