...
| `auto_remove` | `bool` | `true` | Whether to delete the box automatically after it stops |
...
- Other languages: see the [Python quickstart](/getting-started/quickstart-python) and the [Node.js quickstart](/getting-started/quickstart-nodejs).
